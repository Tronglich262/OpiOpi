...
public class PlayerAttackSequence : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        {
            GameObject qObj = GameObject.FindGameObjectWithTag("attackQButton");
            if (qObj != null)
            {
                attackQButton = qObj.GetComponent<Button>();
        ...
        {
            GameObject mObj = GameObject.FindGameObjectWithTag("attackMouseButton");
            if (mObj != null)
            {
                attackMouseButton = mObj.GetComponent<Button>();
